    ...
    public override void OnInspectorGUI() {
        ...
        if (GUILayout.Button("無限ダンジョンWaveList設定")) {
            ...
            for(int i = 0; i < WaveCnt; i++) {
                ...
                if(i == 2) hpRatio = 1.425f;
                if(i == 3) hpRatio = 1.3985f;
                if(i == 4) hpRatio = 1.375f;
                if(i == 5) hpRatio = 1.35f;
                if(i == 6) hpRatio = 1.325f;
                if(i == 7) hpRatio = 1.29875f;
                if(i == 8) hpRatio = 1.26875f;
                if(i == 9) hpRatio = 1.25f;
                if(i == 10) hpRatio = 1.24f;
                if(i == 11) hpRatio = 1.23f;
                if(i == 12) hpRatio = 1.23f;
                if(i == 13) hpRatio = 1.22f;
                if(i == 14) hpRatio = 1.21f;
                if(i == 15) hpRatio = 1.205f;
                if(i == 16) hpRatio = 1.2f;
                if(i == 17) hpRatio = 1.1875f;
                if(i == 18) hpRatio = 1.16f;
                if(i == 19) hpRatio = 1.15f;
                if(i == 20) hpRatio = 1.14f;
                if(i == 21) hpRatio = 1.13f;
                if(i == 22) hpRatio = 1.11f;
                ...
                if(i > 39 && i <= 49) hpRatio   = 1.081f;
                if(i > 49 && i <= 59) hpRatio   = 1.0745f;
                if(i > 59 && i <= 69) hpRatio   = 1.067f;
                if(i > 69 && i <= 79) hpRatio   = 1.061f;
                if(i > 79 && i <= 89) hpRatio   = 1.057f;
                if(i > 89 && i <= 99) hpRatio   = 1.051f;
                if(i > 99 && i <= 139) hpRatio  = 1.0468f;
                if(i > 139 && i <= 179) hpRatio = 1.0437f;
                if(i > 179 && i <= 209) hpRatio = 1.0418f;
                if(i > 209 && i <= 309) hpRatio = 1.0375f;
                if(i > 309 && i <= 409) hpRatio = 1.0329f;
                if(i > 409 && i <= 509) hpRatio = 1.02651f;
                if(i > 509 && i <= 609) hpRatio = 1.0213f;
                if(i > 609 && i <= 709) hpRatio = 1.0186f;
                if(i > 709 && i <= 809) hpRatio = 1.0148f;
                else if(i > 209 && i <= WaveCnt) hpRatio = 1.0115f;
